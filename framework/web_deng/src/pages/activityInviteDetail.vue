    ...
    <div class="box">
      <el-form label-position="right" label-width="120px">
        ...
        <el-form-item label="活动规则">
          ...
          <template v-if="activityShowRes.rules.type == 'level'">
          ...
          <template v-if="activityShowRes.rules.type == 'every'">
            <el-table border class="table-add" :data="activityShowRes.rules.rules">
              <el-table-column prop="done" label="邀请人数(人)">
              </el-table-column>
              <el-table-column prop="money" label="奖励金额(元)">
              </el-table-column>
            </el-table>
          </template>
