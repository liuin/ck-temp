    ...
    <div class="box">
      ...
      <el-form label-position="right" label-width="120px">
        ...
        <el-form-item label="活动规则">
          <el-col :span="10">
            <el-radio v-model="activityUpdateType" label="level">梯度</el-radio>
            <el-radio v-model="activityUpdateType" label="every">递增</el-radio>
            <div class="line1"></div>
            <template v-if="activityUpdateType=='level'">
            ...
            <template v-if="activityUpdateType=='every'">
              <el-table class="table-add" border :data="activityUpdateRules2">
...
export default {
  ...
  created() {
    ...
    this.activityShowCall(this.type).then(data => {
      ...
      if (this.activityUpdateType == "level") {
        this.activityUpdateRules = this.activityUpdate.rules.rules;
      }

      if (this.activityUpdateType == "every") {
        this.activityUpdateRules2 = this.activityUpdate.rules.rules;
      }
    });
  },
  methods: {
