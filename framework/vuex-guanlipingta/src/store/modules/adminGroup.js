  ...
  actions: { //可以异步操作
    ...
    total({
      ...
      return new Promise((resolve, reject) => {
        api.ajax({
          ...
          success: data => {
            commit('setState', [{
              'list.totle': data.admin_group_total
            }, state], {
              root: true
            })
    ...
    sysMenuListInAccessByAdmin({
      ...
      return new Promise((resolve, reject) => {
        api.ajax({
          type: "post",
          url: api.url.sysMenuListInAccessByAdmin,
          data: sendData || {},
          success: data => {
            resolve(data);
          },
    ...
    sysMenuListInAccessByGroup({
      ...
      return new Promise((resolve, reject) => {
        api.ajax({
          type: "post",
          url: api.url.sysMenuListInAccessByGroup,
          data: sendData || {},
          success: data => {
            resolve(data);
          },
    ...
    adminSaveMenuAccess({
      ...
      return new Promise((resolve, reject) => {
        api.ajax({
          type: "post",
          url: api.url.adminSaveMenuAccess,
          data: sendData || {},
          success: data => {
            resolve(data);
          },
    ...
    sysmenuSaveMenuAccess({
      ...
      return new Promise((resolve, reject) => {
        api.ajax({
          type: "post",
          url: api.url.sysmenuSaveMenuAccess,
          data: sendData || {},
          success: data => {
            resolve(data);
          },
