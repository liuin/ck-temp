<template>
  <div class="message-list">
    ...
    <div class="line3"></div>
    <el-button @click="$router.push('/server/add')">新增合作平台</el-button>  
    ...
    <el-table    :data="list.res"  >
     ...
     <pnation v-if="list.total!=0" :total.number="list.total" @changePage="changePage" :size.number="list.count"></pnation>
