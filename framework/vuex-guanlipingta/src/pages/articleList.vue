<template>
  <div class="system-account">
    <div class="box">
        ...
        <el-row :gutter="10">
          <el-col :span="8">
            <el-form-item label="选择分类">
              <el-select clearable filterable v-model="articleList.category_id">
      ...
      <div class="line2"></div>
      <el-button icon="el-icon-edit" size="medium" type="primary" @click="$router.push({path: '/article/listAdd'})" class="btn-edit">添加文章</el-button>
      <div class="line2"></div>


      <el-table border :data="articlePage.res">
