<template>
  <div class="system-account">
    <div class="box">
      <el-button icon="el-icon-edit" type="primary" size="medium" @click="$router.push({path: '/knowledge/logisticsListAdd'})"
        class="btn-edit">添加物流园</el-button>
      <div class="line2"></div>
        ...
        <el-row :gutter="10">
          ...
          <el-col :span="5">
            <el-form-item label="状态" label-width="60px">
              <el-select clearable v-model="searchData.state">
      ...
      <el-table :data="list.res" border>
        <el-table-column prop="province_title" label="省份" width="70px"></el-table-column>
        <el-table-column prop="city_title" label="城市" width="70px"></el-table-column>
        ...
        <el-table-column prop="" label="操作" width="77px">
          <template slot-scope="scope">
